    ...
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      <div className="text-center mb-12">
        ...
        <p className="text-neutral-600 max-w-2xl mx-auto font-sans">
          "Giving is not just making a donation, it is making a difference." Support the logistics, hospitality, and recognition of silent workers at the Divine Awards 2026.
        </p>
      </div>
