...
export default function Sponsorship({ onSubmitSuccess }) {
  ...
  const handleContactEmail = () => {
    window.location.href = "mailto:partnerships@dharafoundations.org?subject=Inquiry%20Regarding%20Divine%20Awards%20Sponsorship&body=Namaste%20Partnerships%20Team,%0A%0AWe%20are%20interested%20in%20sponsoring%20the%20Divine%20Awards%202026.%20Please%20send%20us%20additional%20branding%20collateral%20and%20availabilities.%0A%0ACompany%20Name:%20%0APreferred%20Package:%20";
  };
    ...
    <div style={{ background: '#FAF8F4', minHeight: '100vh', paddingBottom: '100px' }}>
        ...
        <div className="wrap" style={{ position: 'relative', zIndex: 2 }}>
          <div style={{
            ...
            <span style={{ 
              ...
              Divine Awards 2026 Partnership
            </span>
          </div>
          ...
          <h1 style={{ 
            ...
            Partner With Purpose. <br />Sponsor the Divine Awards 2026.
          </h1>
      ...
      <section className="wrap" style={{ marginTop: '100px' }}>
        <div style={{ display: 'grid', gap: '36px', alignItems: 'start' }} className="grid grid-cols-1 lg:grid-cols-3">
          ...
          <div style={{ 
            ...
            <div style={{ position: 'absolute', top: 0, left: '50px', transform: 'translateY(-50%)', background: '#0A3A2A', color: '#fff', padding: '6px 20px', borderRadius: '999px', fontSize: '12px', fontWeight: 'bold', border: '1px solid rgba(217, 166, 70, 0.3)' }}>
              Honoring Excellence
            </div>
            
            <h3 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '24px', marginBottom: '16px', fontWeight: 'bold', marginTop: '10px' }}>
              About Divine Awards 2026
            </h3>
          ...
          {[
            ...
            <div key={idx} className="premium-interactive-card" style={{ 
              ...
              <div style={{ 
                ...
                background: idx === 0 ? 'var(--color-saffron-glow)' : idx === 1 ? '#0A3A2A' : '#D9762E'
              }} />
              
              <h3 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '21px', fontWeight: 'bold', marginBottom: '8px' }}>
                {benefitGroup.title}
              </h3>
            ...
            return (
              <div
                ...
                style={{ 
                  cursor: 'pointer', 
                  borderRadius: '28px', 
                  background: isSelected ? 'linear-gradient(135deg, #0A3A2A 0%, #03211B 100%)' : '#ffffff', 
                  ...
                  boxShadow: isSelected 
                    ...
                    : '0 10px 25px -10px rgba(10, 58, 42, 0.04)',
                  display: 'flex',
              ...
              >
                ...
                <div style={{ borderTop: isSelected ? '1px solid rgba(255,255,255,0.1)' : '1px solid rgba(0,0,0,0.06)', paddingTop: '20px' }}>
                  ...
                  <div style={{ 
                    ...
                    fontSize: '13px', 
                    fontWeight: 'bold',
                    background: isSelected ? '#F3A712' : 'rgba(10, 58, 42, 0.04)',
                    color: isSelected ? '#052622' : '#0A3A2A',
                    transition: 'all 0.2s'
                  }}>
      ...
      <section className="wrap" style={{ marginTop: '100px' }}>
        <div style={{ textAlign: 'center', marginBottom: '50px' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '32px', marginTop: '6px', fontWeight: 'bold' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '24px' }} className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <div key={idx} style={{ 
              ...
              <div>
                <h4 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '18px', fontWeight: 'bold', marginBottom: '12px' }}>
                  {opp.title}
                </h4>
      ...
      <section style={{ 
        ...
        <div className="wrap" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px', textAlign: 'center' }}>
          {[
            { icon: Calendar, title: "Date", info: "January 24, 2026" },
      ...
      <section className="wrap" style={{ marginTop: '100px' }}>
        <div style={{ 
          ...
          <div>
            ...
            <h2 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '32px', marginBottom: '16px', fontWeight: 'bold' }}>
              Download Resources
            </h2>
            ...
            <div style={{ display: 'grid', gap: '12px' }}>
              {[
                "Why Sponsor Divine Awards 2026?",
                ...
                <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '8px', fontSize: '13.5px', color: '#1F2318', fontWeight: idx === 0 ? '700' : '500' }}>
                  {idx > 0 && <Check className="w-4.5 h-4.5 text-emerald-600 flex-shrink-0" />}
                  <span>{bullet}</span>
                </div>
              ))}
            </div>
          ...
          <div style={{ 
            ...
            <h4 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '18px', fontWeight: 'bold', marginBottom: '20px', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
              {[
                ...
                <div key={idx} style={{ 
                  ...
                  <div style={{ fontWeight: 'bold', fontSize: '17px', color: '#0A3A2A', marginBottom: '6px' }}>{partner.name}</div>
      ...
      <section className="wrap" style={{ marginTop: '100px', maxWidth: '800px' }}>
        <h2 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '32px', textAlign: 'center', marginBottom: '40px', fontWeight: 'bold' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.25fr 0.75fr', gap: '60px', alignItems: 'start' }} className="grid grid-cols-1 lg:grid-cols-3">
          ...
          <div style={{ 
            ...
            <form onSubmit={handleSubmit} className="space-y-5" style={{ display: 'grid', gap: '20px' }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }} className="grid grid-cols-1 md:grid-cols-2">
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Company Name *</label>
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Contact Person *</label>
                  <div className="relative">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }} className="grid grid-cols-1 md:grid-cols-2">
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Designation *</label>
                  <div className="relative">
                    <User className="absolute left-3.5 top-3.5 w-4 h-4 text-neutral-400" style={{ position: 'absolute', left: '14px', top: '14px' }} />
                    <input
                      type="text"
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Preferred Package</label>
                  <select
                    name="selectedTier"
                    value={selectedTier}
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }} className="grid grid-cols-1 md:grid-cols-2">
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Phone Number *</label>
                  <div className="relative">
              ...
              <div>
                <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Sponsorship Interest / Specific Goals</label>
                <input
                  type="text"
                  name="interest"
              ...
              <div>
                <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Message *</label>
                <textarea
                  name="message"
                  rows="4"
                  required
          ...
          <div className="lg:col-span-1 space-y-6" style={{ display: 'grid', gap: '24px' }}>
            <div style={{ 
              ...
              <h3 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '20px', fontWeight: 'bold', marginBottom: '24px' }}>
              ...
              <div style={{ display: 'grid', gap: '20px' }}>
                <div style={{ display: 'flex', alignItems: 'start', gap: '12px' }}>
                  ...
                  <div>
                    ...
                    <a href="mailto:partnerships@dharafoundations.org" style={{ display: 'block', fontSize: '14.5px', color: '#0A3A2A', fontWeight: '600', textDecoration: 'none' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'start', gap: '12px' }}>
                  ...
                  <div>
                    ...
                    <a href="tel:+919876543210" style={{ display: 'block', fontSize: '14.5px', color: '#0A3A2A', fontWeight: '600', textDecoration: 'none' }}>
                      +91 98765 43210
                    </a>
                  </div>
                </div>
      ...
      <section style={{ 
        ...
        <div className="wrap">
          ...
          <p style={{ color: '#D5E5CD', fontSize: '18px', maxWidth: '720px', margin: '0 auto 40px', lineHeight: '1.6' }}>
            Join Dhara Foundations as a sponsor of the Divine Awards 2026 and make a lasting impact on communities while showcasing your organization's commitment to social responsibility.
          </p>
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
