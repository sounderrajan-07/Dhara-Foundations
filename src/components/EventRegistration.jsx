...
export default function EventRegistration({ onSubmitSuccess }) {
  ...
  const handleSubmit = (e) => {
    ...
    onSubmitSuccess({
      ...
      message: `Namaste, ${formData.name}. Your presence is gracefully registered for the Divine Awards 2026 under the ${tickets.find(t => t.id === ticketType).name} tier. We look forward to hosting you in this sacred celebration of selfless service.`,
      details: [
  ...
  return (
    <div className="py-12 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
      <div className="text-center mb-12">
        <span className="text-sun-gold font-semibold uppercase tracking-wider text-sm font-sans">Divine Awards 2026</span>
