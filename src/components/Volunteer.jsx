...
export default function Volunteer({ onSubmitSuccess }) {
  ...
  const handleSubmit = (e) => {
    ...
    onSubmitSuccess({
      ...
      message: `Dhanyavaad, Mr./Ms. ${formData.fullName}. Your offer of self-less service (Seva) for the Divine Awards 2026 has been registered. You have selected preferred role as ${roleName}. Our volunteer coordinator will review your skills and dates of availability to invite you for the upcoming orientation session.`,
      details: [
  ...
  return (
    <div style={{ background: '#FAF8F4', minHeight: '100vh', paddingBottom: '100px' }}>
      ...
      <section style={{ 
        position: 'relative', 
        background: 'linear-gradient(135deg, #0A3A2A 0%, #03211B 100%)',
        color: '#fff',
        padding: '120px 20px',
        textAlign: 'center',
        overflow: 'hidden'
      ...
      <section className="wrap" style={{ marginTop: '100px' }}>
        <div style={{ display: 'grid', gap: '36px', alignItems: 'start' }} className="grid grid-cols-1 lg:grid-cols-3">
          ...
          <div>
            ...
            <h2 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '36px', marginBottom: '24px', fontWeight: 'bold', marginTop: '6px' }}>
            ...
            <ul style={{ display: 'grid', gap: '20px', padding: 0, margin: 0, listStyle: 'none' }}>
              {[
                ...
                "Be part of the prestigious Divine Awards 2026.",
          ...
          <div style={{ 
            ...
            boxShadow: '0 20px 40px -15px rgba(10, 58, 42, 0.05)',
            borderRadius: '32px', 
            padding: '40px',
            position: 'relative'
          }}>
            <h3 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '24px', marginBottom: '16px', fontWeight: 'bold' }}>
              Who Can Apply?
            </h3>
            ...
            <div style={{ borderTop: '1px solid rgba(0,0,0,0.06)', paddingTop: '20px' }}>
              <h4 style={{ fontSize: '14px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '12px', textTransform: 'uppercase', fontFamily: 'var(--font-mono)' }}>Eligibility Criteria:</h4>
      ...
      <section id="volunteer-opportunities" className="wrap" style={{ marginTop: '100px' }}>
        <div style={{ textAlign: 'center', marginBottom: '60px' }}>
          ...
          <h2 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '36px', marginTop: '6px', fontWeight: 'bold' }}>
            ...
            return (
              <div key={idx} className="premium-interactive-card" style={{ 
                ...
                <div style={{ 
                  ...
                  background: 'rgba(10, 58, 42, 0.05)', color: '#0A3A2A',
                ...
                <h3 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '20px', fontWeight: 'bold', marginBottom: '16px' }}>
                  {opp.title}
                </h3>
      ...
      <section className="wrap" style={{ marginTop: '100px' }}>
        <div style={{ 
          ...
          {/* Benefits */}
          <div>
            <h3 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '26px', fontWeight: 'bold', marginBottom: '24px' }}>
          ...
          <div style={{ 
            ...
            <h3 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '22px', fontWeight: 'bold', marginBottom: '20px', display: 'flex', itemsAlign: 'center', gap: '8px' }}>
            ...
            <ul style={{ display: 'grid', gap: '16px', padding: 0, margin: 0, listStyle: 'none' }}>
              {[
                ...
                <div key={idx} style={{ display: 'flex', gap: '10px', alignItems: 'start', fontSize: '13.5px', color: '#1F2318' }}>
                  <span style={{ color: '#0A3A2A', fontWeight: 'bold' }}>✓</span>
      ...
      <section style={{ background: '#FAF8F4', padding: '80px 20px', marginTop: '100px', borderTop: '1px solid rgba(0,0,0,0.03)' }}>
        <div className="wrap text-center">
          ...
          <h2 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '36px', marginBottom: '50px', marginTop: '6px', fontWeight: 'bold' }}>
            Volunteer Journey
          </h2>
      ...
      <section style={{ background: '#FAF8F4', padding: '100px 20px', borderTop: '1px solid rgba(0,0,0,0.03)' }}>
        <div className="wrap">
          <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: '48px', alignItems: 'center' }} className="grid grid-cols-1 md:grid-cols-2">
            ...
            {/* FAQ Accordion */}
            <div>
              <h2 style={{ fontFamily: 'var(--font-serif)', color: '#0A3A2A', fontSize: '32px', marginBottom: '32px', fontWeight: 'bold' }}>
                  ...
                  return (
                    <div 
                      ...
                      style={{ 
                        ...
                        borderRadius: '20px',
                        overflow: 'hidden',
                        boxShadow: isOpen ? '0 10px 20px -10px rgba(10,58,42,0.05)' : 'none',
                        transition: 'all 0.2s'
                      }}
                    >
                      <div 
            ...
            <div style={{ 
              ...
              padding: '40px',
              position: 'relative',
              boxShadow: '0 15px 30px -10px rgba(10,58,42,0.05)'
            }}>
              ...
              <div style={{ position: 'relative', zIndex: 2 }}>
                ...
                <h5 style={{ margin: 0, fontSize: '15px', fontWeight: 'bold', color: '#0A3A2A' }}>
                  — Previous Volunteer
                </h5>
              </div>
            </div>
      ...
      <section id="volunteer-registration-form" className="wrap" style={{ marginTop: '80px' }}>
        <div style={{ 
          ...
          borderRadius: '32px', 
          border: '1.5px solid rgba(217, 203, 176, 0.45)', 
          boxShadow: '0 25px 50px -12px rgba(10, 58, 42, 0.05)',
          padding: '48px',
          maxWidth: '900px',
          margin: '0 auto'
        }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '14px', borderBottom: '1px solid rgba(0,0,0,0.06)', paddingBottom: '20px', marginBottom: '28px' }}>
            ...
            <h3 style={{ margin: 0, fontSize: '22px', fontWeight: 'bold', color: '#0A3A2A', fontFamily: 'var(--font-serif)' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-6" style={{ display: 'grid', gap: '20px' }}>
            ...
            <div>
              <h4 style={{ fontSize: '13px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '16px', textTransform: 'uppercase', fontFamily: 'var(--font-mono)', borderBottom: '1px dashed rgba(0,0,0,0.06)', paddingBottom: '6px' }}>
                1. Personal Information
              </h4>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }} className="grid grid-cols-1 md:grid-cols-2">
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Full Name *</label>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 0.8fr', gap: '14px' }}>
                  <div>
                    <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Date of Birth *</label>
                    <input
                      type="date"
                      name="dob"
                      required
                  ...
                  <div>
                    <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Gender *</label>
                    <select
                      name="gender"
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginTop: '20px' }} className="grid grid-cols-1 md:grid-cols-2">
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Email Address *</label>
                  <div className="relative">
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Mobile Number *</label>
                  <div className="relative">
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1.3fr 0.7fr', gap: '20px', marginTop: '20px' }} className="grid grid-cols-1 md:grid-cols-2">
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Address *</label>
                  <input
                    type="text"
                    name="address"
                    required
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>City and State *</label>
                  <input
                    type="text"
                    name="cityState"
                    required
            ...
            <div style={{ marginTop: '10px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }} className="grid grid-cols-1 md:grid-cols-2">
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Occupation *</label>
                  <input
                    type="text"
                    name="occupation"
                    required
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Organization / College Name</label>
                  <input
                    type="text"
                    name="orgName"
            ...
            <div style={{ marginTop: '10px' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }} className="grid grid-cols-1 md:grid-cols-2">
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Preferred Role *</label>
                  <select
                    name="preferredRole"
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Languages Known *</label>
                  <input
                    type="text"
                    name="languages"
                    required
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px', marginTop: '20px' }} className="grid grid-cols-1 md:grid-cols-2">
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Availability Dates *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Areas of Interest *</label>
                  <input
                    type="text"
                    name="areasInterest"
                    required
              ...
              <div style={{ marginTop: '20px' }}>
                <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Skills and Experience *</label>
                <textarea
            ...
            <div style={{ marginTop: '10px' }}>
              ...
              <div>
                <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Why do you want to volunteer? *</label>
                <textarea
                  name="motivation"
                  rows="3"
                  required
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 0.9fr', gap: '20px', marginTop: '20px' }} className="grid grid-cols-1 md:grid-cols-2">
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Emergency Contact Name &amp; Number *</label>
                  <input
                    type="text"
                ...
                <div>
                  <label style={{ display: 'block', fontSize: '11px', fontWeight: 'bold', color: '#0A3A2A', marginBottom: '8px', fontFamily: 'var(--font-mono)', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Medical Conditions / Special Requirements (Optional)</label>
                  <input
                    type="text"
                    name="medicalNotes"
            ...
            <div style={{ display: 'grid', gap: '12px', background: '#FDFBF7', padding: '24px', borderRadius: '16px', border: '1px solid rgba(217,203,176,0.3)', marginTop: '10px' }}>
              <label style={{ display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer', fontSize: '13px', color: '#1F2318' }}>
                <input
                  ...
                  onChange={handleChange}
                  style={{ width: '16px', height: '16px', accentColor: '#0A3A2A' }}
                />
